 ...
 * <p>
 * NotificationSubscriber stores email addresses of users who want to be notified
 * when incidents occur on a specific platform (StatusApp). Each subscriber is
 * associated with a single platform and will receive email notifications when
 * new incidents are created or detected.
 * </p>
 *
 * @see StatusApp
 * @see StatusIncident
