 ...
 * <p>
 * This component provides comprehensive JWT functionality including token generation,
 * validation, and claim extraction. It supports both access tokens and refresh tokens
 * with configurable expiration times.
 * </p>
 * <p>
 * JWT tokens generated by this utility include the following claims:
 * <ul>
 *     <li>subject - the username</li>
 *     <li>userId - the user's unique identifier</li>
 *     <li>email - the user's email address</li>
 *     <li>organizationId - the user's organization identifier</li>
 *     <li>role - the user's role in the system</li>
 ...
 * <ul>
 *     <li>{@code jwt.secret} - Base64-encoded secret key for signing tokens</li>
 *     <li>{@code jwt.expiration} - Access token expiration time in milliseconds</li>
 *     <li>{@code jwt.refresh.expiration} - Refresh token expiration time in milliseconds</li>
 * </ul>
 * </p>
 *
